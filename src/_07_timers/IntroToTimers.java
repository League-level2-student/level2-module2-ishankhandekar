...
public class IntroToTimers extends JPanel implements ActionListener, KeyListener{
	...
	private void setup() {
		...
		time = maxTime;
		// 3. Initialize timer to a new Timer object. For the first argument, use 1000/speed. 
//		For the second argument, use this
		timer = new Timer(1000,this);
		// 11. Run it! Notice how it doesn't update? That's because our timer isn't triggering the actionPerformed() 
//		method yet!
